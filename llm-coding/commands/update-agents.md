...
1. **Read current AGENTS.md** - Understand what's already documented
...
4. **Keep it concise** - AGENTS.md should stay <300 lines. If adding something, consider what to remove.
